...
Manual for **0.7-beta**, checked against the code on **September 23, 2026**.
...
and `SHA256SUMS` from [v0.7-beta](https://github.com/govlog/ttyloom/releases/tag/v0.7-beta).
...
This manual describes **0.7-beta**. See the [changelog](../CHANGELOG.md) and
