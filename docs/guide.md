...
Manual for **0.9-beta**, checked against the code on **September 24, 2026**.
...
and `SHA256SUMS` from [v0.9-beta](https://github.com/govlog/ttyloom/releases/tag/v0.9-beta).
...
This manual describes **0.9-beta**. See the [changelog](../CHANGELOG.md) and
