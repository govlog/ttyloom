...
Manual for **0.8-beta**, checked against the code on **September 23, 2026**.
...
and `SHA256SUMS` from [v0.8-beta](https://github.com/govlog/ttyloom/releases/tag/v0.8-beta).
...
This manual describes **0.8-beta**. See the [changelog](../CHANGELOG.md) and
